...
class CustomAWSWAFv2RegexPatternSetTagsRule < BaseRule
  ...
  def audit_impl(cfn_model)
    violating_resources = cfn_model.resources_by_type('AWS::WAFv2::RegexPatternSet').select do |resource|
      resource.tags.nil?
    end
