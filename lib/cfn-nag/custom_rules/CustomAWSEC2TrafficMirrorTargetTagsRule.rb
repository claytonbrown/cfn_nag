...
class CustomAWSEC2TrafficMirrorTargetTagsRule < BaseRule
  ...
  def audit_impl(cfn_model)
    violating_resources = cfn_model.resources_by_type('AWS::EC2::TrafficMirrorTarget').select do |resource|
      resource.tags.nil?
    end
