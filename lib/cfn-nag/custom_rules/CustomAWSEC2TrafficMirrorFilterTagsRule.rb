...
class CustomAWSEC2TrafficMirrorFilterTagsRule < BaseRule
  ...
  def audit_impl(cfn_model)
    violating_resources = cfn_model.resources_by_type('AWS::EC2::TrafficMirrorFilter').select do |resource|
      resource.tags.nil?
    end
