...
class CustomAWSIAMRoleTagsRule < BaseRule
  ...
  def audit_impl(cfn_model)
    violating_resources = cfn_model.resources_by_type('AWS::IAM::Role').select do |resource|
      resource.tags.nil?
    end
