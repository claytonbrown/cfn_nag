...
class CustomAWSDocDBDBClusterParameterGroupTagsRule < BaseRule
  ...
  def audit_impl(cfn_model)
    violating_resources = cfn_model.resources_by_type('AWS::DocDB::DBClusterParameterGroup').select do |resource|
      resource.tags.nil?
    end
