...
class CustomAWSWAFv2RuleGroupTagsRule < BaseRule
  ...
  def audit_impl(cfn_model)
    violating_resources = cfn_model.resources_by_type('AWS::WAFv2::RuleGroup').select do |resource|
      resource.tags.nil?
    end
