...
class CustomAWSApiGatewayV2DomainNameTagsRule < BaseRule
  ...
  def audit_impl(cfn_model)
    violating_resources = cfn_model.resources_by_type('AWS::ApiGatewayV2::DomainName').select do |resource|
      resource.tags.nil?
    end
