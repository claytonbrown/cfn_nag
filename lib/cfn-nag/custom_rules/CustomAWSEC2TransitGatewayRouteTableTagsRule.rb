...
class CustomAWSEC2TransitGatewayRouteTableTagsRule < BaseRule
  ...
  def audit_impl(cfn_model)
    violating_resources = cfn_model.resources_by_type('AWS::EC2::TransitGatewayRouteTable').select do |resource|
      resource.tags.nil?
    end
