...
class CustomAWSCloud9EnvironmentEC2TagsRule < BaseRule
  ...
  def audit_impl(cfn_model)
    violating_resources = cfn_model.resources_by_type('AWS::Cloud9::EnvironmentEC2').select do |resource|
      resource.tags.nil?
    end
